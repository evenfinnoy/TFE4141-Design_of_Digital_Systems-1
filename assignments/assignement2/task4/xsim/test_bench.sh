...
#
# Script generated by Vivado on Tue Sep 01 15:01:06 +0200 2026
# SW Build 6299465 on Fri Nov 14 19:35:11 GMT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : test_bench.sh
...
#
# Usage        : test_bench.sh
#                test_bench.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                test_bench.sh [-rerun]
#                test_bench.sh [-reset_run]
#                test_bench.sh [-clean]
#                test_bench.sh [-reset_log]
#                test_bench.sh [-help]
#
...
# script info
echo -e "test_bench.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./test_bench.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L secureip -L xpm --snapshot test_bench xil_defaultlib.test_bench -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim test_bench -key {Behavioral:sim_1:Functional:test_bench} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb test_bench.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./test_bench.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: test_bench.sh [-help]\n\
Usage: test_bench.sh [-step]\n\
Usage: test_bench.sh [-lib_map_path]\n\
Usage: test_bench.sh [-rerun]\n\
Usage: test_bench.sh [-reset_run]\n\
Usage: test_bench.sh [-clean]\n\
Usage: test_bench.sh [-reset_log]\n\
Usage: test_bench.sh [-keep_index]\n\
Usage: test_bench.sh [-noclean_files]\n\n\
